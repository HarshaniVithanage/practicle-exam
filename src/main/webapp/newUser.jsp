...
<script src="js/Controllers/controllerMain.js" type="text/javascript"> </script>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class='alert alert-danger' id="divValidate" > </div>
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<button type="submit" id = 'btnAddUser'class="btn btn-primary">Add
												User</button>
										</div>
					</form>
